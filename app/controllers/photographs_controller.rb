class PhotographsController < ApplicationController
  ...
  before_action :authenticate_photographer!, except: [:index, :show]
  ...
  private
    ...
    def photograph_params
      params.require(:photograph).permit(:category, :photographer_id, :image)
    end
    
    def correct_user
      @photograph = current_photographer.photographs.find_by(id: params[:id])  
      redirect_to photographs_path, notice: "Not Authorized to edit this photograph" if @photograph.nil?
    end
